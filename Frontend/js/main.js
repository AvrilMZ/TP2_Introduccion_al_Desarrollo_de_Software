...
function mostrarFotos(n) {
	...
	if (n > fotosCarrousel.length) {
		carrouselIndex = 1;
	} // Si el índice es mayor que la cantidad, vuelve al primero
	if (n < 1) {
		carrouselIndex = fotosCarrousel.length;
	} // Si el índice es menor que 1, va al último
...
document.addEventListener('DOMContentLoaded', () => {
	const textoCarrousel = document.querySelector('.textoCarrousel');
	const botonPaisesContenedor = document.querySelector(
